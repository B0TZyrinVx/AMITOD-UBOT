    ...
    try:
        ...
        async def opeen(event):
            try:
                ...
                return await event.edit("⛔ **Woy Kau? Kamu Tidak Diizinkan Untuk Menekan**!")
        ...
        async def handler(event):
            if event.user_joined or event.user_added:
                ...
                await event.reply(
                    ...
                    buttons=[
                        [Button.url("ZyrinVx | U$BOT" ,
                                    "https://t.me/Roycheater")],
                    ],
                )
        ...
        async def handler(event):
            if event.message.from_id != uid:
                ...
                reply_pop_up_alert = f"🚫Hai ! Kau Buat Apa?🚫 Kau Tak Ganteng Jadi Tak Usah Menggunakan Milik {DEFAULTUSER} Nanti Kena Karma."
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                ...
                reply_pop_up_alert = f"✘ Hai! ✘\n\nKau Tk Ganteng Jadi Tidak Mempunyai Hak Untuk Menekan Button Ini."
                await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    f"❁ __Saya Adalah ZyrinVx | U$BOT Yang Digunakan Owner Untuk Bersenang Senang Sahaja__.\n\n"
                    f"❁ __Saya Dibuat Karna ZyrinVx Sedang Galau ;-)__.\n\n"
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = f"{DEFAULTUSER}Pilih Setting yang dibawah :"
                await event.edit(
                    text,
                    file=kyuralogo,
                    link_preview=True,
                ...
                reply_pop_up_alert = f"✘ Hai!✘\n\nKamu Tak Ganteng Jadi Tidak Mempunyai Hak Untuk Menekan Button Ini."
                await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                ...
                reply_pop_up_alert = f"✘ Hai!✘\n\nKamu Tak Ganteng Jadi Tidak Mempunyai Hak Untuk Menekan Tombol Button Ini."
                await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    ...
                    f"× **Pembaruan Data Untuk ⚠️@ZyrinVx | U$BOT⚠️, Command Untuk Pembaruan**.\n"
                    f"⚒Pembaruan Data :\n"
                    f"`.update deploy`\n"
                    f"`update`\n\n"
                    f"⚠️@ZyrinVx | U$BOT⚠️")
        ...
        async def killdabot(event):
            if event.query.user_id == uid:
                text = f"**Kamu Tak Ganteng Aku Tak Tahan Bye Restaring ⚠️@ZyrinVx | U$BOT⚠️**..."
                await event.edit(
                    text,
                    file=kyuralogo,
                    link_preview=True,
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith(""):
                ...
                result = builder.article(
                    "My Name Is Tumulak I From Thailand **⚠️@ZyrinVx | U$BOT⚠️**",
                    text="Daftar Plugins",
                    buttons=[],
                    link_preview=True,
                )
            else:
                result = builder.article(" **⚠️@ZyrinVx | U$BOT⚠️**",
                                         text="""⚠️@ZyrinVx | U$BOT⚠️""",
                                         buttons=[[custom.Button.url("⚠️@ZyrinVx | U$BOT⚠️",
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:  # pylint:disable=E0602
                ...
                reply_pop_up_alert = (
                    f"🚫Hai! Kamu Buat Apa!!!! 🚫 Kamu Tak Ganteng Jadi Tak Usah Menggunakan Milik {DEFAULTUSER}."
                )
                await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:  # userbot
                ...
                await event.edit(
                    ...
                    buttons=[
                        [
                            Button.url("❈ꜱᴜᴘᴘᴏʀᴛ❈", "t.me/Roycheater"),
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:  # pylint:disable=E0602
                ...
                reply_pop_up_alert = (
                    f"🚫Hai! Kamu Buat Apa!!! 🚫 KamuTak Ganteng Jadi Tak Usah Menggunakan Milik {DEFAULTUSER}."
                )
                await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
